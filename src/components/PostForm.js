...
export const PostForm = ({ setWillFetch }) => {
    ...
    async function uploadText() {
        ...
        axios.post("http://13.229.71.180:3001/post/createPost", data)
        .then(res => {
            setWillFetch(true)
        })
        .catch((error) => {
    ...
    function onDrop(selectedImage) {
        ...
        //pictures.map(image => {
            ...
            axios.post('http://13.229.71.180:3001/post/uploadImage', formData)
                .then(res => {
    ...
    function removeSelectedImage(index) {
        ...
        axios.post(`http://13.229.71.180:3001/post/removeSelectedImage/${key}`)
        .then(res => {
