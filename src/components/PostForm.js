...
export const PostForm = ({ setWillFetch }) => {
    ...
    async function uploadText() {
        ...
        axios.post("https://52.77.230.105:3001/post/createPost", data)
        .then(res => {
            setWillFetch(true)
        })
        .catch((error) => {
    ...
    function onDrop(selectedImage) {
        ...
        //pictures.map(image => {
            ...
            axios.post('https://52.77.230.105:3001/post/uploadImage', formData)
                .then(res => {
    ...
    function removeSelectedImage(index) {
        ...
        axios.post(`https://52.77.230.105:3001/post/removeSelectedImage/${key}`)
        .then(res => {
